...
uint256 hashGenesisBlock("0xfab32e5715eebc5c8cc5fde68d1aaddf334b425c3d605ec758f62270e6b5326e");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x48fe7f5b7cb1317edfa77d2f8d1dbbb24d272ad1f12ceed287e9c695112d050e");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "NY Times 23/mar/2018 Steve Jobs, Apple’s Visionary, Dies at 56";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1521796909;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085072510;

        if (fTestNet)
        {
            block.nTime    = 1521796898;
            block.nNonce   = 385832654;
        }
...
if (true && block.GetHash() != hashGenesisBlock)
{
    ...
    printf("block.GetHash = %s\n", block.GetHash().ToString().c_str());
        ...
        assert(block.hashMerkleRoot == uint256("0x3b5f02748d13a7d72bdd26e3d2f54cf4efea07fd8594179123f70316bb1e4641"));
        block.print();
